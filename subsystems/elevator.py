...
class ElevatorConstants:
    ...
    kP = 0.05  # at first make it very small like this, then start tuning by increasing from there
...
class Elevator(Subsystem):
    def __init__(
            ...
            motorClass=SparkMax,
            limitSwitchType=LimitSwitchConfig.Type.kNormallyOpen, # This should be normally closed
            arm=None,
    ) -> None:
        """
